#
#  Be sure to run `pod spec lint SZLogger.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   A longer description of SZLogger in Markdown format.
  ...
  s.homepage     = "https://github.com/Zhukn1/SZLogger"
  ...
  s.source       = { :git => "https://github.com/Zhukn1/SZLogger.git", :tag => "0.0.1" }
